...
var commonInitialisms = map[string]*regexp.Regexp{
	...
	"AMD":    regexp.MustCompile("Amd([^a-z]+|$)"),
	"AUD":    regexp.MustCompile("Aud([^a-z]+|$)"),
	"CAD":    regexp.MustCompile("Cad([^a-z]+|$)"),
	"CNY":    regexp.MustCompile("Cny([^a-z]+|$)"),
	"GBP":    regexp.MustCompile("Gbp([^a-z]+|$)"),
	"MXN":    regexp.MustCompile("Mxn([^a-z]+|$)"),
	"SOM":    regexp.MustCompile("Som([^a-z]+|$)"),
	"BTC":    regexp.MustCompile("Btc([^a-z]+|$)"),
	"ETH":    regexp.MustCompile("Eth([^a-z]+|$)"),
	"LTC":    regexp.MustCompile("Ltc([^a-z]+|$)"),
	"TRX":    regexp.MustCompile("Trx([^a-z]+|$)"),
	"USDC":   regexp.MustCompile("Usdc([^a-z]+|$)"),
	"USDCT":  regexp.MustCompile("UsdcT([^a-z]+|$)"),
	"USDT":   regexp.MustCompile("Usdt([^a-z]+|$)"),
	"USDTT":  regexp.MustCompile("UsdtT([^a-z]+|$)"),
	"BCH":    regexp.MustCompile("Bch([^a-z]+|$)"),
	"DAI":    regexp.MustCompile("Dai([^a-z]+|$)"),
	"AMPL":   regexp.MustCompile("Ampl([^a-z]+|$)"),
